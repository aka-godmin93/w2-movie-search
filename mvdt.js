document.addEventListener("DOMContentLoaded", () => {
    ...
    function makeActor(actors) {
        ...
        actors.forEach(function (actor) {
            ...
            const profileUrl = actor.profile_path !== null ? `https://image.tmdb.org/t/p/w500${actor.profile_path}` : "https://placehold.jp/696969/ffffff/300x450.png?text=NO%20IMAGE";
...
function displayReviews() {
    ...
    reviews.forEach((review) => {
        ...
        reviewDiv.innerHTML = `
          <p class="reviewer">Review by  ${review.author}</p>
          <p class="reviewTxt">${review.review}</p>
          <div class="rvBtn">
          <button class="reviewEdit" onclick="editReview(${review.id})">Edit</button>
          <button class="reviewDel" onclick="deleteReview(${review.id})">Del</button>
          </div>
      `;
...
function editReview(id) {
    ...
    if (newPassword === undefined || newPassword === null || newPassword.trim() === "") return;
    ...
    if (index !== -1) {
        ...
        if (newPassword === reviews[index].password) {
            ...
            if (newReview === undefined || newReview === null || newReview.trim() === "") return;
